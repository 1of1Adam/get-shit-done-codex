...
```bash
INIT=$(node ~/.codex/get-shit-done/bin$gsd-tools.js init resume)
```
...
⚠️  Interrupted agent detected:
    ...
    Resume with: spawn_agent tool (resume parameter with agent ID)
...
→ Primary: Resume interrupted agent (spawn_agent tool with resume parameter)
